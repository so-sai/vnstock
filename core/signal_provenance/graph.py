...
class SignalEdge(BaseModel):
    ...
    attenuation: dict = Field(default_factory=lambda: {"noise_gain": 0.0, "information_loss": 0.0},
...
class SignalProvenanceGraph(BaseModel):
    ...
    nodes: Dict[str, SignalProvenanceNode] = Field(default_factory=dict, description="Map of node IDs to SignalProvenanceNode objects.")

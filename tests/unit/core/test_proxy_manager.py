...
class TestProxyClass:
    ...
    def test_proxy_creation(self):
        ...
        proxy = Proxy(protocol="http", ip="192.168.1.1", port=8080, country="US", speed=50.0)
...
class TestProxyManager:
    ...
    def test_fetch_proxies_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            "status": "ok",
            "proxies": [
                {"protocol": "http", "ip": "192.168.1.1", "port": "8080", "country": "US", "speed": 50.5},
                {"protocol": "https", "ip": "10.0.0.1", "port": "3128", "country": "UK", "speed": 75.2},
            ],
        }
    ...
    def test_parse_proxy_data_standard_format(self):
        ...
        proxy_data = [{"protocol": "http", "ip": "192.168.1.1", "port": "8080", "country": "US", "speed": 50.0}]
    ...
    def test_parse_proxy_data_ipport_format(self):
        ...
        proxy_data = [{"protocol": "https", "ipport": "10.0.0.1:3128", "country": "UK", "speed": 75.0}]
    ...
    def test_parse_proxy_data_invalid_port(self):
        ...
        proxy_data = [{"protocol": "http", "ip": "192.168.1.1", "port": "invalid", "country": "US"}]

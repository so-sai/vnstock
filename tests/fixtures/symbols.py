...
def diverse_test_symbols(random_hose_symbols, random_hnx_symbols, random_upcom_symbols):
    ...
    return {"hose": hose_sample, "hnx": hnx_sample, "upcom": upcom_sample, "all": hose_sample + hnx_sample + upcom_sample}


@pytest.fixture
def all_test_symbols(
    random_hose_symbols, random_hnx_symbols, random_upcom_symbols, derivative_symbols, sample_covered_warrants, sample_bonds
):

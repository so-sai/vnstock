...
from vnstock.core.utils.transform import (
    clean_html_dict,
...
class Company:
    ...
    def _process_data(self, data: Dict, data_key: str, columns_dict: Optional[Dict] = None) -> pd.DataFrame:
        """
    ...
    def shareholders(self) -> pd.DataFrame:
        ...
        df = df.rename(columns={"owner_full_name": "share_holder", "percentage": "share_own_percent"})
    ...
    def officers(self, filter_by: str = "working") -> pd.DataFrame:
        ...
        # Rename columns for clarity
        df = df.rename(
            columns={"full_name": "officer_name", "position_name": "officer_position", "percentage": "officer_own_percent"}
        )

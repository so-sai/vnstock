...
from vnstock.core.utils.transform import flatten_hierarchical_index, replace_in_column_names
from vnstock.core.utils.user_agent import get_headers
from vnstock.core.utils.validation import validate_symbol
from vnstock.explorer.vci import Company

from .const import _FINANCIAL_REPORT_PERIOD_MAP, _GRAPHQL_URL, _ICB4_COMTYPE_CODE_MAP, _UNIT_MAP, SUPPORTED_LANGUAGES
...
class Finance:
    ...
    def _get_ratio_dict(self, show_log: Optional[bool] = False, get_all: Optional[bool] = False) -> pd.DataFrame:
        """
    ...
    def _ratio_mapping(
        self, ratio_df: pd.DataFrame, lang: Optional[str] = "en", mode: str = "final", show_log: Optional[bool] = False
    ):
        """
        ...
        orphan_columns = [
            col for col in original_columns if col not in mapping_df["field_name"].values and col not in index_part.columns
        ]
        if show_log:
        ...
        primary_reports = ["Chỉ tiêu cân đối kế toán", "Chỉ tiêu lưu chuyển tiền tệ", "Chỉ tiêu kết quả kinh doanh"]

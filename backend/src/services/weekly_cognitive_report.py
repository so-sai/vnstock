...
def _gold_semantic(gold: dict) -> dict:
    ...
    if stress:
        return {
            ...
            "explanation_vi": f"Vàng nội địa đang chịu áp lực lớn (phí bảo hiểm {premium_pct:.0f}%), chênh lệch với thế giới ở mức báo động.",  # noqa: E501 - chuỗi nội dung dài (i18n/SQL)
            "severity": 0.80,
        }
    if premium == "SURGE":
        return {

...
class ProviderManager:
    ...
    def active_source(self) -> str | None:
        ...
        for p in self._providers:
            ...
            try:
                if p.is_available():
                    return p.name
            except Exception:  # noqa: BLE001 - batch isolation: 1 provider lỗi → thử provider tiếp theo
                continue
        return None
    ...
    def _try_call(self, method: str, *args: Any, **kwargs: Any):
        ...
        for provider in self._providers:
            ...
            except Exception as e:  # noqa: BLE001 - fallback ladder: provider lỗi → thử provider tiếp theo

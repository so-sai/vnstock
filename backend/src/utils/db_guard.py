...
OPERATIONAL_TABLES = {
    ...
    "macro_history",
    "regime_history",
    "capital_displacement_history",
    "flow_forecast_history",
    "market_foreign_history",
    "portfolio_recommendations",
    "risk_governance_history",
    "rsi_regime_history",
}
    ...
    if is_memory_brain:
        ...
        def authorizer(action, arg1, arg2, arg3, arg4):
            if action == sqlite3.SQLITE_CREATE_TABLE and arg1 in OPERATIONAL_TABLES:
                logger.critical(f"DB_GUARD: Chan hanh vi tao bang Operational '{arg1}' trong Memory Brain!")
                return sqlite3.SQLITE_DENY
            if action == sqlite3.SQLITE_INSERT and arg1 in OPERATIONAL_TABLES:
                logger.critical(f"DB_GUARD: Chan hanh vi ghi du lieu vao bang '{arg1}' trong Memory Brain!")
                return sqlite3.SQLITE_DENY

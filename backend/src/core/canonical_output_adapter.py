...
CLI_LABEL_MAP: dict[str, str] = {
    ...
    "P(Gain)": "P(Lãi)",
    "P(Gain|Evidence)": "P(Lãi|Bằng chứng)",
    "Alloc%": "Tỷ trọng%",
    "Allocation": "Phân bổ",
    "EU": "Kỳ vọng",
    "EU Ranking": "Xếp hạng Kỳ vọng",
    "Calib Penalty": "Phạt Hiệu chỉnh",
    "v2 Inputs": "Đầu vào v2",
    "Evidence Inputs": "Đầu vào Bằng chứng",
    "P0 MacroState": "P0 Trạng thái VM",
    "P1 Transmission": "P1 Lan truyền",
    "P1 SectorPhase": "P1 Pha Ngành",
    "P2 Health": "P2 Sức khỏe",
    ...
    "None": "Không",
    "Stress": "Áp lực",
    "RAW MACRO DRIVERS": "CHỈ SỐ VĨ MÔ THÔ",
    "NORMALIZED DRIVERS": "CHỈ SỐ CHUẨN HÓA",
    "POSITION SCALARS": "HỆ SỐ VỊ THẾ",
    "General": "Tổng quát",
    ...
    "CAUSAL PROPAGATION": "LAN TRUYỀN NHÂN QUẢ",
    "CAUSAL PATH": "ĐƯỜNG ĐI NHÂN QUẢ",
    ...
    "Nodes": "Nút",
    "Archetypes": "DNA",
    "Universal edges": "Cạnh phổ quát",
    "Avg confidence": "Tin cậy TB",
    "Counter-examples logged": "Phản ví dụ đã ghi",
    "No causal path from": "Không có đường đi nhân quả từ",
    "Summary": "Tổng kết",
    "Compounded confidence": "Tin cậy tổng hợp",
    "Total lag": "Độ trễ tổng",
    "days": "ngày",
    "Information loss": "Mất mát thông tin",
    "Counter-examples exist on this path": "Tồn tại phản ví dụ trên đường đi này",
    "Universal": "Phổ quát",
    "Persisted": "Đã ghi",
    ...
    "Archetype": "DNA",
    "Macro": "Vĩ mô",
    "Competing Hypotheses": "Giả thuyết Cạnh tranh",
    "Bayesian Model Averaging": "Tổng hợp BMA",
    "ACTIVE": "HOẠT ĐỘNG",
    "DORMANT": "TẠM NGƯNG",
    "RETIRED": "ĐÀO THẢI",
